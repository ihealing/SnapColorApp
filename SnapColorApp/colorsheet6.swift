...
struct showSheet6View: View {
    var body: some View {
        VStack{
            ZStack{
                RoundedRectangle(cornerRadius: 20)
                    .fill(Color(red: 0.641, green: 0.203, blue: 0.158))
...
struct colorsheet6_Previews: PreviewProvider {
